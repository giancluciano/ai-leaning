...
train_data, y = vertical_data(BATCH_LEN, N_CLASSES)
...
with cProfile.Profile() as pr:
    nn = NeuralNetwork(layers_shape = (2,2,2, N_CLASSES)) # layers shape is a tuple of int (number of neurons for each layer)
    nn.softmax_train(train_data, y, INTERATIONS)
